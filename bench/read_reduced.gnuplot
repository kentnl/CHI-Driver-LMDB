...
plot \
  ...
  'results/read_reduced/lmdb_nosync_nosync_multi.csv' using (bin($1)):(1.0) smooth freq with linespoints title columnhead(1),\
  'results/read_reduced/lmdb_sync_nosync_multi.csv' using (bin($1)):(1.0) smooth freq with linespoints title columnhead(1),\
  'results/read_reduced/lmdb_nosync_sync_multi.csv' using (bin($1)):(1.0) smooth freq with linespoints title columnhead(1),\
  'results/read_reduced/lmdb_sync_sync_multi.csv' using (bin($1)):(1.0) smooth freq with linespoints title columnhead(1),\
